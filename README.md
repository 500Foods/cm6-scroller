...
across the app, even in Firefox. 

Here's an example showing Tabulator on the left and CodeMirror 6 on the right, both with visible scrollbars.
...
<!--CLOC-START -->
```cloc
Last updated at 2026-05-03 21:59:43 UTC
-------------------------------------------------------------------------------
